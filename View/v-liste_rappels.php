...
<body style="background-color: antiquewhite;">
    ...
    <?php endif; ?>
    <br>
  <a href="index.php" ><button style="color:rgb(194, 2, 46); cursor: pointer; background-color:#ffffff;text-align:center;padding:15px;width:200px; border-color: rgb(37, 153, 255);"> Retour </button></a>
</body>
